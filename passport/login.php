...
<html>
	...
	<link href="../css/base.css?v=5112" rel="stylesheet" />
	<link href="../css/login.css?v=1219" rel="stylesheet" />
	...
	<title>账号登录-个人管理系统</title>
	</head>

	<body>
	<div id="login_header">
	  <p class="left">个人管理系统</p>
	</div>
	<div id="login">
	  <div id="login_left">
	    <form action="" name="login" method="post">
	      <table>
	        ...
	        <tr>
	          <th>账号：</th>
	          <td><input type="text" name="account" id="account" value="<?php echo $_COOKIE['account']; ?>" class="login_input_txt" size="30" />
